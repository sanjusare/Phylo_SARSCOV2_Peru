...
final_table<-tabla_u%>%
  dplyr::select(name_analysis,strain,EPI_ISL=Accession.ID,date=Collection_date,host=Host,age=Patient.age,gender=Gender,pango_lineage=Pango.lineage,pango_ver=Pangolin.version,variant=Variant,Continent,Country,City)
